...
class CsvFile(object):
    ...
    def create_table_of_contents(self):
        ...
        sheet["B2"] = self.report_details["total_rules"]
        sheet["B2"].alignment = Alignment(wrapText=True)
        sheet.merge_cells("B3:E3")
        sheet["B3"] = len(self.report_details["violated_rules"])

        # Resources Table
        for i, rule in enumerate(self.report_details["all_rules"]):
            # Row height
        ...
        # Footer
        row_number = len(self.report_details["all_rules"]) + 5
